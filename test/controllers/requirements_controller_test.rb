...
class RequirementsControllerTest < ActionController::TestCase
  ...
  test "should create requirement" do
    assert_difference('Requirement.count') do
      post :create, requirement: { goal_id: @requirement.goal_id, goal_type: @requirement.goal_type, instructions: @requirement.instructions, name: @requirement.name }
    end
  ...
  test "should update requirement" do
    patch :update, id: @requirement, requirement: { goal_id: @requirement.goal_id, goal_type: @requirement.goal_type, instructions: @requirement.instructions, name: @requirement.name }
    assert_redirected_to requirement_path(assigns(:requirement))
  end
