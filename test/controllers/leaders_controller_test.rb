...
class LeadersControllerTest < ActionController::TestCase
  ...
  test "should create leader" do
    assert_difference('Leader.count') do
      post :create, leader: { email: @leader.email, first_name: @leader.first_name, last_name: @leader.last_name, speciality_id: @leader.speciality_id }
    end
  ...
  test "should update leader" do
    patch :update, id: @leader, leader: { email: @leader.email, first_name: @leader.first_name, last_name: @leader.last_name, speciality_id: @leader.speciality_id }
    assert_redirected_to leader_path(assigns(:leader))
  end
